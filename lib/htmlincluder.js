...
module.exports = {
  initialize: function initialize(options) {
    return console.log('options:', options), (0, _config.setOptions)(options);
  },
...
var resolveNode = function resolveNode(node, json) {
  ...
  if (node.children.length > 0) node.content = node.children.map(function (c) {
    return c.content;
  }).join('');
...
var nodeProcessors = {
  ...
  wrap: function wrap(node, json) {
    ...
    // load contents from file
    node.content = _config.wrapFiles[filename].content;
